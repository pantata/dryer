...
Suis les etapes ci-dessous pour installer le plugin dans ZMOD.

### 1) Activer le plugin dans ZMOD

Mets ZMod a jour.
Execute la macro `ENABLE_EXTRA_PLUGINS`.

### 2) Activer/desactiver le plugin
