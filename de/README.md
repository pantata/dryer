...
Folge den untenstehenden Schritten, um das Plugin in ZMOD zu installieren.

### 1) Plugin in ZMOD aktivieren

Aktualisiere ZMod.
Fuehre das Makro `ENABLE_EXTRA_PLUGINS` aus.

### 2) Plugin aktivieren/deaktivieren
